...
from .binary_structs.fds_binary import fds_fundus_header, fds_header, fds_oct_header
...
class FDS(object):
    ...
    def read_oct_volume(self):
        ...
        with open(self.filepath, "rb") as f:
            ...
            raw = f.read(22)
            oct_header = fds_oct_header.parse(raw)
            number_pixels = (
    ...
    def read_fundus_image(self):
        ...
        with open(self.filepath, "rb") as f:
            ...
            f.seek(chunk_location)
            raw = f.read(21)
            fundus_header = fds_fundus_header.parse(raw)
